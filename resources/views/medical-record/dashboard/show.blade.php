                                ...
                                <div class="row d-flex flex-column w-75">
                                    ...
                                    <div class="row ml-1 mt-2 mb-2 d-flex justify-content-between mb-4 w-100">
                                        <span class="py-sm-2" style="color: grey">
                                            Height <br>
                                            <span id="height" style="color: black">{{ !empty($user->personal->height) ? $user->personal->height : 'N/A'}}</span>
                                        </span>
                                        <span class="py-sm-2" style="color: grey">
                                            Weight <br>
                                            <span id="weight" style="color: black">{{ !empty($user->personal->weight) ? $user->personal->weight : 'N/A' }}</span>
                                        </span>
                                        <span class="py-sm-2" style="color: grey">
                                            Blood <br>
