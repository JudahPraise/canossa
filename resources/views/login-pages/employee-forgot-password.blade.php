    ...
    <div class="row">
         ...
         <div class="col-xs-12 col-lg-7 area">
             <div class="d-flex flex-column justify-content-center align-items-center login-container" style="z-index: 999;">
                 <form class="login-form text-center" action="{{ route('forgotpass.request') }}" method="POST">
                    @csrf
                     ...
                     <div class="container mb-4">
                         <h1 class="font-weight-bold text-left" style="color: black; font-size: 3rem; letter-spacing: 2px;">Forgot<br>Password<span class="dot animate__animated animate__bounce" id="dot"></span></h1>
                    ...
                    <div class="form-group">
                        <input type="date" name="dob" class="form-control rounded-pill form-control-lg bg-transparent"  placeholder="Employee ID" required>
                    </div>
                     <button type="submit" class="btn mt-4 rounded-pill btn-lg btn-custom btn-block text-uppercase">Send Request</button>
                 </form>
             </div>
          </div>
    </div>
