             ...
             <div class="d-flex flex-column justify-content-center align-items-center login-container" style="z-index: 999;">
                 <form class="w-50">
                     ...
                     <div class="container mb-4">
                         <h1 class="font-weight-bold text-left" style="color: black; font-size: 3rem; letter-spacing: 2px;">Request<br>Status: <span class="text-warning">Pending</span><span class="dot animate__animated animate__bounce" id="dot"></span></h1>
                     </div>

                   <div class="container">
                        <p>Kindly contact the admins and follow up your request.</p>
                   </div>
