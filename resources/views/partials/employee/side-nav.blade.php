...
<div class="bg-light border-right" id="sidebar-wrapper" style="color: black">
    ...
    <div class="sidenavs">
        ...
        <div class="list-group list-group-flush">
            <h4 class="list-group-item bg-light">HRIS</h4>
        ...
        <!-FIXME:IF College Teacher Only -->
        <div class="list-group list-group-flush">
            <h4 class="list-group-item bg-light">CSIS</h4> 
            <a class="list-group-item list-group-item-action bg-light" href="#!">Schedule</a>
            <a class="list-group-item list-group-item-action bg-light" href="#!">Sections</a>
            <a class="list-group-item list-group-item-action bg-light" href="#!">Grading</a>
        </div>
