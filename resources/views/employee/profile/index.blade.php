                ...
                <div class="col-lg-3 order-lg-2">
                    <div class="card-profile-image avatar-upload">
                        ...
                        @if(empty(auth()->user()->image))
                            <a href="#" onclick="document.getElementById('imageUpload').click()">
                                <img src="{{ asset(auth()->user()->sex === 'Male' ? 'img/default-male.svg' : 'img/default-female.svg') }}" class="rounded-circle" style="height: 144px; width: 200px; overflow: hidden;">
                            </a>
                        @endif
                    </div>
                </div>
