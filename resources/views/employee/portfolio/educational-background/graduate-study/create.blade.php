...
<div class="container-fluid">
  <form id="form" action="{{ route('grad.store') }}" method="POST">
      @csrf
      {{-- Full Name --}}
      <div class="form-row">
      ...
      <div class="form-row">
        <div class="col-md-6 mb-3">
          ...
          <input type="date" class="form-control" name="graduated_date_from" id="graduated_date_from" >
        </div>
        <div class="col-md-6 mb-3">
          <label for="graduated_date_to">To</label>
          <input type="date" class="form-control" name="graduated_date_to" id="graduated_date_to" >
        </div>
      </div>
      {{-- Physical --}}
      <div class="form-row">
