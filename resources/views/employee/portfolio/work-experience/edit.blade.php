...
<div class="container-fluid">
    <form id="form" action="{{ route('work.update', Auth::user()->id) }}" method="POST"  enctype="multipart/form-data">
        @method('PUT')
        @csrf
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                              ...
                              <input type="text" class="form-control" name="work_description[]" value="{{ $experience->work_description }}" id="work_description">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                              <label for="duration">Duration</label>
                              <input type="text" class="form-control" name="duration[]" value="{{ $experience->duration }}" id="duration" required>
                            </div>
                            <div class="col-md-6 mb-3">
                              <label for="work_place">Work place</label>
                              <input type="text" class="form-control" name="work_place[]" value="{{ $experience->work_place }}" id="work_place">  
                            </div>
                        </div>
