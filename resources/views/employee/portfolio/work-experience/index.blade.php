...
<div class="container-fluid">
    <div class="row w-100">
        ...
        <div class="col-6 d-flex justify-content-end align-items-center" style="height: 4rem;">
            ...
            <a href="{{ route('work.create') }}" class="btn btn-icon btn-success btn-sm" type="button">
                <span class="btn-inner--icon"><i class="fas fa-plus"></i></span>
            </a>
            <a href="{{ route('work.edit', Auth::user()->id) }}" class="btn btn-icon btn-info btn-sm" type="button">
