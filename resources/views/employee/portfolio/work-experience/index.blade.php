...
<div class="container-fluid">
    <div class="row pt-5">
        ...
        <div class="col-6 d-flex justify-content-end align-items-center" style="height: 4rem;">
            ...
            <a href="{{ route('work.edit', Auth::user()->id) }}" class="{{ !empty($experiences) ? 'neu-effect' : 'neu-effect-inset' }} d-flex justify-content-center align-items-center text-decoration-none py-2 px-2" style="display:inline-block; "><i class="fas fa-edit" style="font-size: 1.6rem"></i></a>
        </div>
    </div>
