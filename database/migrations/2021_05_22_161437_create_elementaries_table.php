...
class CreateElementariesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('elementaries', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('level')->default('elementary');
    ...
    {
        Schema::dropIfExists('elementaries');
    }
}
